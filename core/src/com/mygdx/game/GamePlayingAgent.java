  ...
  //  	printCell(C);
    ...
    private int alphabeta(Cell2[][] C,int depth,int alpha,int beta, int current_player)
    {
    		...
    		while(countNode>0)
    		{
            	...
            	v = MaxOf(v,returnedValue);
           		if(depth==0 && (v-returnedValue)==0)
            		...
            		//	System.out.println("At level 0 selected value  = "+selectedNode.value);
            		}
            			alpha = MaxOf(alpha,v);
            			if(beta<=alpha)
            			{
    	...
    	else
    	{
    		...
    		while(countNode>0)
    		{
            	...
            	//if(depth==1 && (v-returnedValue)==0)
       			{
        		//	System.out.println("At level 1 selected value  = "+selectedNode.value);
        		}
            			beta = MinOf(beta,v);
            			if(beta<=alpha)
            			{
    ...
    /*	if(current_player==1)
      ...
      x= random(columns-1);
    	...
    	System.out.println("in Agent... player = "+Player);
